import{_ as f,cu as y,g as o,p as i,k as n,m as p,q as s,h as l,a3 as w,cv as h,c0 as d,x as m,v as g,b0 as x,b1 as _,bW as k}from"./index-7j7S2aY6.js";import{V as A}from"./VMain-Cm0UmKGi-CiX2aXhu.js";import"./ssrBoot-Zgc_Ttvi-L4xtH0j4.js";class $ extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
