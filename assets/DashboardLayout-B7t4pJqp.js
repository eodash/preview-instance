import{_ as b,W as y,Z as i,$ as s,a0 as n,a7 as f,a4 as o,a1 as l,a3 as c,aa as v,a2 as p,a5 as d,m,F as x,a6 as _,ab as $}from"./index-sM6GxOqw.js";import{V as A}from"./VMain-BPOrTz6T.js";import"./ssrBoot-CntoNbRn.js";class k extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
