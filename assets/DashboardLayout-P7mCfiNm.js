import{_ as b,t as f,d as i,e as s,w as n,x as c,b as l,y as p,S as d,r as m,g,F as v,z as x,h as _}from"./main-Q31mW-EY.js";import{V as k}from"./VMain-DIMzqgFb.js";import{u as o,d as A}from"./templates-CP4OFojK.js";import"./ssrBoot-B5WM2mWe.js";class $ extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
