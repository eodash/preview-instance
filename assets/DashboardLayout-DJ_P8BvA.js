import{_ as b,Z as f,a1 as i,a2 as s,a3 as n,e as c,a7 as o,a4 as l,a6 as p,n as v,a5 as d,a8 as m,m as g,F as x,a9 as _,ac as k}from"./index-BfirqpGG.js";import{V as A}from"./VMain-Ci8WLI7U.js";import"./ssrBoot-uABtHCHd.js";class $ extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
