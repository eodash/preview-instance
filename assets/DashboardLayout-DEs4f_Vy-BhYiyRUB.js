import{_ as b,gu as y,g as o,p as i,k as n,m as h,q as s,h as l,O as w,gv as d,fY as c,x as m,v as g,az as x,aA as _,f_ as k}from"./index-DAubJ0S3.js";import{V as A}from"./VMain-DvMmOL4f-BRyaSdhC.js";import"./ssrBoot-Zgc_Ttvi-BE1J4_2J.js";class $ extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
