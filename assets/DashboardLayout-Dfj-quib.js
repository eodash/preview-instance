import{_ as b,t as f,e as s,d as i,w as n,A as c,b as l,S as p,r as d,g as m,x as g,F as v,y as x,h as _}from"./main-CJJy3JI9.js";import{V as A}from"./VMain-coM4Jf22.js";import{u as o,d as k}from"./templates-BBKD2u9z.js";import"./ssrBoot-MnO2kaUK.js";class $ extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
...
`)}
      ...
      <slot></slot>
    `}attributeChangedCallback(e,a,t){a!==t&&(this[e]=t),this.render()}}customElements.define("eox-layout",$);customElements.define("eox-layout-item",B);const E=["gap"],C=["id","h","w","x","y"],L={class:"bg-surface pointer"},S={__name:"DashboardLayout",setup(u){const{bgWidget:e,importedWidgets:a,gap:t}=f(),h={padding:t.value+"px",overflow:"hidden !important"};return(w,M)=>(s(),i(A,{class:"pa-0"},{default:n(()=>[c("eox-layout",{mediaBreakpoints:[0,960,1920],gap:o(t),style:h},[o(e)?.component?(s(),l("eox-layout-item",{key:o(e).id,class:"bg-panel",style:k(`margin: -${o(t)+1}px;`),x:"0",y:"0",h:"12",w:"12"},[(s(),i(p,null,{default:n(()=>[(s(),i(d(o(e)?.component),m({id:"bg-widget"},o(e)?.props),null,16))]),_:1}))],4)):g("v-if",!0),(s(!0),l(v,null,x(o(a),(r,y)=>(s(),i(_,{key:y,name:"fade"},{default:n(()=>[r.value.component?(s(),l("eox-layout-item",{id:r.value.id.toString(),key:r.value.id,class:"panel",h:r.value.layout.h,w:r.value.layout.w,x:r.value.layout.x,y:r.value.layout.y},[(s(),i(p,null,{default:n(()=>[c("div",L,[(s(),i(d(r.value.component),m({key:r.value.id},{ref_for:!0},r.value.props),null,16))])]),_:2},1024))],8,C)):g("v-if",!0)]),_:2},1024))),128))],8,E)]),_:1}))}},I=b(S,[["__scopeId","data-v-9c8477cc"]]);export{I as default};
