import{_ as b,t as f,e as s,d as i,w as n,A as c,b as l,S as p,r as d,g as m,x as g,F as v,y as x,h as _}from"./main-DqshxVGm.js";import{V as A}from"./VMain-B-8oEglF.js";import{u as o,d as k}from"./templates-BBKD2u9z.js";import"./ssrBoot-DTnlEOXF.js";class $ extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
